...
const CChainParams &Params() { return chainparams; }
...
public:
    CLegacyNetwork()
    {
        ...
        assert(
            genesis.hashMerkleRoot == uint256S("0x4db82fe8b45f3dae2b7c7b8be5ec4c37e72e25eaf989b9db24ce1d0fd37eed8b"));
        ...
        mapCheckpoints = {{0, uint256S("0xa60ac43c88dbc44b826cf315352a8a7b373d2af8b6e1c4c4a0638859c5e9ecd1")},
...
public:
    CTestnet0Network()
    {
        ...
        mapCheckpoints = {{0, uint256S("0xcdf2b68d2fc9afdf991df5e321f59198189926ee757bf5efcf5c8c1a07b7c90e")}};
    }
};
...
public:
    CRegtestNetwork()
    {
        ...
        assert(
            genesis.hashMerkleRoot == uint256S("0x3565e20605dbdfe7a63ec4b9f5b9d2d25b69fcc13d6bfd7cc42615fcd41a323c"));
        ...
        mapCheckpoints = {{0, uint256S("0x296d58ef241b0dde2372fbc7b09ec4aacf7b4dad88561f02469f3f4695c4fbb1")}};
    }
};
